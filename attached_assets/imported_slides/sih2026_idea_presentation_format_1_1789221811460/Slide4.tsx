      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "700",
            color: "#000000"
          }}>{"FEASIBILITY AND VIABILITY"}</span></p></div><div key={2} style={{
        position: "absolute",
        left: "64px",
        top: "266px",
        width: "985.33px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            color: "#000000"
          }}>{"Analysis of the feasibility of the idea"}</span></p><p style={{
          textAlign: "justify",
          lineHeight: "1.2",
          textIndent: "-36px",
          paddingLeft: "36px",
          ...
          marginBottom: "0"
            ...
            fontFamily: "Arial, 'Helvetica Neue', sans-serif",
            color: "#000000"
          }}>{"Potential challenges and risks"}</span></p><p style={{
          textAlign: "justify",
          lineHeight: "1.2",
          textIndent: "-36px",
          paddingLeft: "36px",
          ...
          marginBottom: "0"
            ...
            fontFamily: "Arial, 'Helvetica Neue', sans-serif",
            color: "#000000"
          }}>{"Strategies"}</span><span style={{
            fontSize: "calc(28pt * var(--pptx-font-scale, 1))",
            fontFamily: "Arial, 'Helvetica Neue', sans-serif",
            color: "#000000"
          }}>{" for overcoming these challenges"}</span></p></div><div key={3} style={{
        position: "absolute",
        left: "488px",
        top: "667.33px",
        width: "336.38px",
